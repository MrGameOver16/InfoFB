...
def show_program():
	...
	print '''
                    %sINFORMASI%s
[]=====================================================[]
[] AUTHOR   : Mr.GameOver (aadityaa)                   []
[] WhatsApp : 081299140544                             []
[] YouTube  : https://youtube.com/c/aadityaa           []
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + '(aadityaa'+ W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' )==> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'aadityaa' + W +'/' + R +'Bot ' + W + '==> ')
